...
_Uno;
//nombre de mi tabla
DB::table('registros_totales')->insert(
    ['nombre' => $_POST["nombre"],
    'apellido' => $_POST["apellido"],
    'nombres_de_usuarios' => $_POST["nombres_de_usuarios"],
    'password' => $_POST["password"],
    'edad' => $_POST["edad"],
    'correo' => $_POST["correo"],
]);
echo "<h3 class='title is-3 centrado has-background-black has-text-danger'>Sus regístros se guardaron correctamente</h3>";
echo "<br>";
echo "<div class='centrado'><button class='button is-link is-outlined'><a href='formulariocliente.php'>Regresar</a></button></div>";
