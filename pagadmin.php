            ...
            <body class="colorpagina">
               ...
               <br>
                <div class="centrado">
                    ...
                    <button type="button" class="button is-link is-outlined"><a href="Secciones.php">Regresar a pedir Productos</a></button>
                </div>
                <br><br>
_Uno;
    ...
    <div class="table-container">
        <table class="table has-background-success tabla3 centrarCar">
            ...
            <tr> 
                ...
                <td>$colum->edad</td>
                <td>$colum->correo</td>
                <td class='centrado'><a class='button' href='delete.php?id={$colum->idregistros_totales}'>ELIMINAR</a></td>
            </tr>
        </table>
    </div>
_Consultar;
    ...
    <div class="table-container">
        <table class="table has-background-success tabla3 centrarCar">
            ...
            <tr> 
                ...
                <td>$colum->estado</td>
                <td class='centrado'><a class='button' href='delete.php?id={$colum->iddireccion_cliente}'>ELIMINAR</a></td>
            </tr>
        </table>
    </div>
_Consultar;
        ...
        <table class="table has-background-success tabla3 centrarCar">
            <thead class="has-background-info">
                <tr class="tabla4 centrado">
                    ...
                    <th>Nombre del producto 2</th>
                    <th>Nombre del producto 3</th>
                    <th>OPERACIÓN</th>
                </tr>
            </thead>
            <tr> 
                ...
                <td>$colum->nombre_producto2</td>
                <td>$colum->nombre_producto3</td>
                <td class='centrado'><a class='button' href='delete.php?id={$colum->idproducto}'>ELIMINAR</a></td>
            </tr>
        </table>
    </div>
_Consultar;
    ...
    <div class="table-container">
        <table class="table has-background-success tabla3 centrarCar">
            ...
            <tr> 
                ...
                <td class='centrado'><a class='button' href='delete.php?id={$colum->idtipo_tamano}'>ELIMINAR</a></td>
            </tr>
        </table>
    </div>
_Consultar;
    ...
    <div class="table-container">
        <table class="table has-background-success tabla3 centrarCar">
            ...
            <tr> 
                ...
                <td class='centrado'><a class='button' href='delete.php?id={$colum->idcategorias}'>ELIMINAR</a></td>
            </tr>
        </table>
    </div>
_Consultar;
