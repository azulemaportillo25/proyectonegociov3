                        ...
                        <div class="tile">
                            <div class="tile is-parent is-vertical">
                               <article class="tile is-child notification is-primary">
                                    <p class="title centrado">"Ingrese las secciones de Artesanías en Madera que le guste"</p>
                                    <br>
        
                                    <form method="post" action="insertarcategoria.php">
                                        <div class="centrado">
                                            <label class="label" for="nombre_seccion">Nombre de la sección</label>
                                           <input class="input is-rounded" type="text" placeholder="Rounded input" id="nombre_seccion" name="nombre_seccion">
                                        </div><br>
                                       <button type="submit"class="button is-danger is-outlined">Guardar datos</button>
                                        <button type="button" class="button is-link is-outlined"><a href="Productos.php">Nombre de los Productos</a></button>
                                    </form>
